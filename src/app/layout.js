...
export const metadata = {
  ...
  keywords: ["장은아", "전시디자인", "전시웹사이트", "전시", "그래픽", "웹개발", "웹", "그래픽디자이너", "그래픽디자인", "공연", "XR", "미디어아트", "디자인", "도록 디자인", "리플렛디자인", "한국예술종합학교", "디자이너", "협조적블루", "cooperative", "blue", "graphic", "design", "euna", "한예종", "현대무용", "공연", "씨어터", "무용", "퍼포먼스", "시각예술"],
  openGraph: {
